...
AbstractListItem {
     ...
     *
     * This can either be a string, a URL, or an object with the following properties:
     *
     * - `name`: string
     * - `source`: string
     * - `width`: int
     ...
     * - `color`: color
     *
     * In TypeScript terminology, the type for this property is:
     * 
     * @code ts
     * interface IconGroup {
     *     name:   string,
     ...
     * @endcode
     *
     * If the type of the icon is string, the icon will be looked up from the
     * user's icon theme.
     *
     ...
     *
     * If the icon's original colors should be left intact, set this to "transparent".
     *
     * @since 2.7
     */
